...
on all the other variables in the dataset. The approach assumes the
missing data pattern to be Missing At Random (MAR), i.e., for each
variable, the probability of missingness is indepedent of the missing
data of the variable conditionally on the observed data for the
variable and other variables in the dataset [@rubin_litte_2019].
...
as covariates is specified. Overall, $30$ imputed datasets are generated
after $30$ iterations each.
